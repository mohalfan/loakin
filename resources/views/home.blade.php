        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php } else { ?>
                        <div class="col-lg-8 col-12 ml-auto" style="padding-left: 0; padding-right: 0; display: flex; flex-direction: row;">
        ...
        <div class="container pb-4" style="border-bottom: 3px dashed grey;">
            ...
            <div style="display: flex; flex-direction: row;">
                ...
                <p class="mt-auto mb-auto ml-3">
                    <a href="" data-toggle="modal" data-target="#carabuattoko" style="text-decoration: none; color: #1492E6; font-weight: bold;">Tata cara buka toko</a>
                    <div class="modal fade" id="carabuattoko" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Cara buka toko</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <p>1. Klik tombol buka toko</p>
                                    <p>2. Masukkan data informasi toko</p>
                                    <p>3. Tekan tombol simpan</p>
                                </div>
                                <div class="modal-footer">
    ...
    <div class="container pt-4">
        <div class="row">
                        ...
                        <div class="col-6 pl-0 pr-0">
                            <?php for ($i = 0; $i < sizeof($kategori) / 2; $i++) { ?>
                                <li class="nav-item" id="lifooter">
                                    <a class="nav-link" href="{{'#'.$kategori[$i]->nama_kategori}}" style="font-family: 'Montserrat', sans-serif;" onclick="getbykategori(<?php echo $kategori[$i]->id ?>)">{{$kategori[$i]->nama_kategori}}</a>
                                </li>
                            <?php } ?>
                        </div>
                        <div class="col-6 pl-0 pr-0">
            ...
            <div class="col-3">
                ...
                <ul class="pl-0" style="list-style-type: none">
                    <li>
                        <a href="" data-toggle="modal" data-target="#carabuattoko" style="text-decoration: none; color: #1492E6; font-weight: bold;">Tata cara buka
                            toko</a>
                    </li>
                    <li>
                        <a href="#" data-toggle="modal" data-target="#carajualbarang" style="text-decoration: none; color: #1492E6; font-weight: bold;">Tata cara jual
                            barang</a>
                        <div class="modal fade" id="carajualbarang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Cara Jual Barang</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p>1. Pastikan anda telah memiliki toko</p>
                                        <p>2. Pergi ke halaman toko saya</p>
                                        <p>3. Tekan tombol tambah barang jualan dibawah gambar toko anda</p>
                                        <p>4. Isikan data data yang diperlukan</p>
                                        <p>5. Klik tombol simpan</p>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                    ...
                    <li>
                        <a href="#" data-target="#carabelibarang" data-toggle="modal" style="text-decoration: none; color: #1492E6; font-weight: bold;">Tata cara beli
                            barang</a>
                        <div class="modal fade" id="carabelibarang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Cara Beli Barang</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p>1. Login terlebih dahulu untuk melakukan transaksi</p>
                                        <p>2. Pilih item yang ingin anda beli, lalu klik tombol tambahkan ke keranjang</p>
                                        <p>3. Klik menu keranjang saya untuk melihat barang yang akan anda beli</p>
                                        <p>4. Anda bisa menambah atau mengurangi jumlah item yang dibeli dengan menekan tombol plus dan minus</p>
                                        <p>5. Pastikan anda membeli satu atau beberapa item pada satu toko untuk sekali checkout</p>
                                        <p>6. Tekan tombol checkout untuk melanjutkan</p>
                                        <p>7. Tunggu verifikasi admin</p>
                                        <p>8. Lakukan pembayaran dan upload bukti pembayaran</p>
                                        <p>9. Tunggu verifikasi admin dan tunggu proses sampai barang diterima</p>
                                        <p>10. Barang anda terima dan transaksi selesai</p>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                    ...
                    <li>
                        <a href="#" data-target="#carabayar" data-toggle="modal" style="text-decoration: none; color: #1492E6; font-weight: bold;">Tata cara pembayaran</a>
                        <div class="modal fade" id="carabayar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Cara Pembayaran Transaksi</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p>1. Transfer melalui atm ke rekening : 55100923091230 (BRI)<br>A.N : Mohammad Alfan Iqbal Aknaf</p>
                                        <p>2. Transfer melalui aplikasi mobile banking ke rekening : 55100923091230 (BRI)<br>A.N : Mohammad Alfan Iqbal Aknaf</p>
                                        <p>3. Jika pembayaran dalam 1x24 jam tidak diverifikasi silahkan hubungi admin melalui WA</p>
                                        <p>4. Untuk tata cara transfer bisa anda lihat sendiri di gugel jika anda kurang paham :)</p>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                    ...
                    <br>
                    <li>
                        <p style="font-weight: bold">Contact Admin<br>WA : 081334744293</p>
                    </li>
                </ul>
            </div>
            <div class="col-3">
